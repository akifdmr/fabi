  ...
  methods: {
    prepareConfig() {
      ...
      this.events.forEach((hook) => {
        ...
        safeConfig[hook] = arrayify2(safeConfig[hook] || []).concat(globalCallbacks, localCallback);
      });
      const onCloseCb = this.onClose.bind(this);
      safeConfig["onClose"] = arrayify2(safeConfig["onClose"] || []).concat(onCloseCb);
