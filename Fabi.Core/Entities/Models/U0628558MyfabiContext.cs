...
public partial class U0628558MyfabiContext : DbContext
{
    public U0628558MyfabiContext()
    {
    }

    public U0628558MyfabiContext(DbContextOptions<U0628558MyfabiContext> options)
        : base(options)
    {
    }

    public virtual DbSet<AccountRoleRelation> AccountRoleRelations { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    {
        modelBuilder.Entity<AccountRoleRelation>(entity =>
        {
            entity.Property(e => e.Id).ValueGeneratedNever();
            entity.Property(e => e.CreatedDate).HasColumnType("datetime");
            entity.Property(e => e.UpdatedDate).HasColumnType("datetime");

            entity.HasOne(d => d.Account).WithMany(p => p.AccountRoleRelations)
                .HasForeignKey(d => d.AccountId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_AccountRoleRelations_Account");

            entity.HasOne(d => d.Role).WithMany(p => p.AccountRoleRelations)
                .HasForeignKey(d => d.RoleId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_AccountRoleRelations_Role");
        });
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Account__3214EC0775379182");
            ...
            entity.HasOne(d => d.Address).WithMany(p => p.ApplicationUsers)
                .HasForeignKey(d => d.AddressId)
                .HasConstraintName("ApplicationUser_FK_1");
        ...
        modelBuilder.Entity<RefreshToken>(entity =>
        {
            ...
            entity.HasOne(d => d.ApplicationUser).WithMany(p => p.RefreshTokens)
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Role__3214EC075F8193FE");
