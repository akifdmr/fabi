...
public class AuthRepository : IAuthRepository
{
    ...
    public async Task<AuthDto> RegisterAsync(RegisterDto dto)
    {
        ...
        return _mapAuthUserData(user, userRoles: new List<Role> { Role.User }, jwtSecurityToken, refreshToken);
    }
    ...
    public async Task<AuthDto> GetTokenAsync(LoginDto dto)
    {
        ...
        return _mapAuthUserData(user, userRoles: (await _userManager.GetRolesAsync(user)).ToList().Select(t=>Enum.Parse<Role>(t)).ToList(),
    ...
    private AuthDto _mapAuthUserData(ApplicationUser user, List<Role> userRoles,
