        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
          ...
          <div class="sm:flex sm:justify-between sm:items-center mb-4">
            ...
            <div class="mb-4 sm:mb-0">
              <h1 class="text-2xl md:text-3xl text-slate-800 font-bold"><span>{{`${monthNames[month]} ${year}`}}</span> ✨</h1>
            </div>
          ...
          <div class="bg-white rounded-sm shadow overflow-hidden">
            ...
            <div class="grid grid-cols-7 gap-px border-b border-slate-200">
              <div class="px-1 py-3" v-for="(day, index) in dayNames" :key="index">
                ...
                <div class="text-slate-500 text-sm font-medium text-center hidden lg:block">{{day}}</div>
              </div>
            </div>
            ...
            <div class="grid grid-cols-7 gap-px bg-slate-200">
              ...
              <div class="bg-slate-50 h-20 sm:h-28 lg:h-36" v-for="(blankday, index) in startingBlankDays" :key="index">
                ...
                <div class="h-full flex flex-col justify-between">
                  ...
                  <div class="flex justify-between items-center p-0.5 sm:p-1.5">
                    ...
                    <button
                      ...
                      class="text-xs text-slate-500 font-medium whitespace-nowrap text-center sm:py-0.5 px-0.5 sm:px-2 border border-slate-200 rounded"
                    >
              ...
              <div class="bg-slate-50 h-20 sm:h-28 lg:h-36" v-for="(blankday, index) in endingBlankDays" :key="index">
                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
                  <rect width="100%" height="100%" fill="url(#stripes)" />
                </svg>
              </div>
